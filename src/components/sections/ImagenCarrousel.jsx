        ...
        <div key={index}>
            {Math.abs(currentImage - index) <= 2 ? (
                <div className='w-full h-full p-0 '>
                    <img className='w-full h-full rounded-lg' src={imagen.src} alt={imagen.alt} />
                    <div className='w-full aling-middle h-fit absolute top-[45%]'>
                        ...
                        >
                            <KeyboardArrowRight className='opacity-40 hover:opacity-70' sx={{height:'100%', width:'100%'}}/>
                        </button>:null}
                        ...
                        >
                            <KeyboardArrowLeft className='opacity-40 hover:opacity-70' sx={{height:'100%', width:'100%'}} />
                        </button>:null}      
                    </div>
                </div>
              ) : null}
